...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
      title: 'My App',
      // favicon: './client/img/favicon.ico', //favicon路径
      filename: './creditcard/bank_icbc/index.html', //生成的html存放路径，相对于 path
      template: './bin/index.template.html', //html模板路径
      inject: true, //允许插件修改哪些内容，包括head与body
      hash: true, //为静态资源生成hash值
      minify: { //压缩HTML文件
      ...
      chunks: [
        'creditcard/bank_icbc'
      ]
    }),
    new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
      title: 'My App',
      // favicon: './client/img/favicon.ico', //favicon路径
      filename: './activities/baitiao/get_coupon/index.html', //生成的html存放路径，相对于 path
      template: './bin/index.template.html', //html模板路径
      inject: true, //允许插件修改哪些内容，包括head与body
      hash: true, //为静态资源生成hash值
      minify: { //压缩HTML文件
