...
import CptBankList from './component/bankList/main';
...
let selectCallBack = function(item){
  console.log('selected bankInfo',item)
};

ReactDOM.render(
  <CptBankList bankList={bankList} selectItem={selectItem} selectCallBack={selectCallBack}/>,
  document.getElementById('root')
)